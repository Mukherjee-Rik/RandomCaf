...
const milestones = [
  { year: '2023', text: '22 CAFE was founded with a vision: to brew more than just coffee — to create a space for genuine human connection.' },
      ...
      <section id="story" className="scroll-mt-20 py-28 px-6 bg-espresso text-cream">      <div className="max-w-5xl mx-auto">
        ...
        <FadeUp delay={0.2}>
          <p className="font-sans text-latte/80 text-center max-w-2xl mx-auto mt-6 text-lg leading-relaxed">
            At 22 CAFE, we believe exceptional coffee fosters genuine connection. Every cup is crafted with care, turning daily rituals into moments worth savoring.
          </p>
        </FadeUp>
